...
pub struct EventHandlers {
    pub a_unit_dies:            Vec<fn(&mut Game, UnitID) -> ()>,
    pub a_unit_steps:           Vec<fn(&mut Game, UnitID) -> ()>,
    pub a_unit_is_attacked:     Vec<fn(&mut Game, UnitID, UnitID) -> ()>,
    pub a_unit_is_damaged:      Vec<fn(&mut Game, UnitID, UnitID, f32) -> ()>,
    pub a_unit_uses_ability:    Vec<fn(&mut Game, UnitID, AbilityID, Target) -> ()>,
    pub a_unit_ends_ability:    Vec<fn(&mut Game, UnitID, AbilityID, Target) -> ()>,
}
