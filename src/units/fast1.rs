...
pub fn prototype() -> Unit {
    ...
    unit.set_unit_type(ul::id(ul::UnitType::Fast1));
    ...
    unit.set_weight(1.0);
    unit.set_top_speed(4.0);
    unit.set_acceleration(2.0);
    unit.set_deceleration(4.0);
    unit.set_turn_rate(PI / 1.5);
    unit.set_health_regen(0.0);
    unit.set_max_health(65.0);
...
fn wpn_proto() -> Weapon {
    ...
    wpn.set_attack_type(AttackType::MissileAttack(ml::id(ml::MissileType::Fast1)));
    wpn.set_xy_offset((-0.1,0.0));
    wpn.set_turn_rate(PI);
    wpn.set_lock_offset(mv::normalize(0.0));
    wpn.set_firing_arc(PI);
    wpn.set_range(9.0);
    wpn.set_firing_offset(0.3);
    wpn.set_fire_rate(9.0);
    wpn.set_alternating(false);
    wpn.set_barrels(1);
    wpn.set_barrel_spacing(0.0);
    wpn.set_salvo_size(15);
