    ...
    if (nTranscrType < 8) {
        ...
        conversionSwitch: switch (nTranscrType) {
            ...
            case 1:
                ...
                /* the source has a fixed-length encoding but the new StringView has a letiable-length encoding... */
            ...
            case 2:
                ...
                /* the source has a letiable-length encoding but the new StringView has a fixed-length encoding... */
            ...
            case 3:
                ...
                /* both the source and the new StringView have a letiable-length encoding... */
...
StringView.putUTF8CharCode = function (aTarget, nChar, nPutAt) {
    ...
    if (nChar < 0x80 /* 128 */) {
        ...
        aTarget[nIdx++] = 0x80 /* 128 */ + ((nChar >>> 6) & 0x3f /* 63 */);
        aTarget[nIdx++] = 0x80 /* 128 */ + (nChar & 0x3f /* 63 */);
    } else if (nChar < 0x4000000 /* 67108832 */) {
        /* five bytes */
        ...
        aTarget[nIdx++] = 0x80 /* 128 */ + ((nChar >>> 6) & 0x3f /* 63 */);
        aTarget[nIdx++] = 0x80 /* 128 */ + (nChar & 0x3f /* 63 */);
    } else /* if (nChar <= 0x7fffffff) */ { /* 2147483327 */
        /* six bytes */
...
/* Array of bytes to base32 string decoding */

StringView.b32ToUint6 = function (nChr) {

    return nChr > 32 && nChr < 91 ?
        nChr - 65
      : nChr > 96 && nChr < 123 ?
        nChr - 71
      : nChr > 47 && nChr < 58 ?
...
StringView.uint6ToB32 = function (nUint6) {
...
/* Base32 string to array encoding */

StringView.bytesToBase32 = function (aBytes) {

    let sB32Enc = "";

    for (let nMod3, nLen = aBytes.length, nUint24 = 0, nIdx = 0; nIdx < nLen; nIdx++) {
        nMod3 = nIdx % 3;
        if (nIdx > 0 && (nIdx * 4 / 3) % 76 === 0) { sB32Enc += "\r\n"; }
        nUint24 |= aBytes[nIdx] << (16 >>> nMod3 & 24);
        if (nMod3 === 2 || aBytes.length - nIdx === 1) {
            sB32Enc += String.fromCharCode(StringView.uint6ToB32(nUint24 >>> 18 & 63), StringView.uint6ToB32(nUint24 >>> 12 & 63), StringView.uint6ToB32(nUint24 >>> 6 & 63), StringView.uint6ToB32(nUint24 & 63));
            nUint24 = 0;
        }
    }

    return sB32Enc.replace(/A(?=A$|$)/g, "=");

};


StringView.base32ToBytes = function (sBase32, nBlockBytes) {

    let
      sB32Enc = sBase32.replace(/[^A-Za-z0-9\+\/]/g, ""), nInLen = sB32Enc.length,
    ...
    for (let nMod3, nMod4, nUint24 = 0, nOutIdx = 0, nInIdx = 0; nInIdx < nInLen; nInIdx++) {
        nMod4 = nInIdx & 3;
        nUint24 |= StringView.b32ToUint6(sB32Enc.charCodeAt(nInIdx)) << 18 - 6 * nMod4;
...
StringView.makeFromBase32 = function (sB32Inpt, sEncoding, nByteOffset, nLength) {

    return new StringView(sEncoding === "UTF-16" || sEncoding === "UTF-32" ? StringView.base32ToBytes(sB32Inpt, sEncoding === "UTF-16" ? 2 : 4).buffer : StringView.base32ToBytes(sB32Inpt), sEncoding, nByteOffset, nLength);
...
StringView.prototype.toBase32 = function (bWholeBuffer) {

    return StringView.bytesToBase32(
      bWholeBuffer ?
        (
...
StringView.prototype.subview = function (nCharOffset /* optional */, nCharLength /* optional */) {
    ...
    let
      ...
      nChrLen, nCharStart, nStrLen, bletiableLen = this.encoding === "UTF-8" || this.encoding === "UTF-16",
    ...
    nStringLength = bletiableLen ? this.makeIndex() : nRawLen;
